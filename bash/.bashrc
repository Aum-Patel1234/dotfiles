...
if [ $? -eq 0 ]; then
  ...
  if [ -f "/home/aum/anaconda3/etc/profile.d/conda.sh" ]; then
    . "/home/aum/anaconda3/etc/profile.d/conda.sh"
  else
...
alias ..='cd ..'
alias ...='cd ../..'
alias ml='cd ~/Desktop/Artificial\ Intelligence/Machine\ Learning/'
alias dl='cd ~/Desktop/Artificial\ Intelligence/deep_learning/'
alias ad='cd ~/Desktop/Android\ Development/'
alias exp='cd ~/Desktop/exploring/'
alias web='cd ~/Desktop/Web\ Projects\ and\ Learnings/'
alias c='clear'
alias gb='git branch'
alias cdac='conda deactivate'
alias cml='conda activate ml'
alias spy='/usr/bin/python3'
alias cmk='cd build && cmake .. && make'
